...
(function($) {
    ...
    // Kotare addition 2015
    this.removeLine = function(option) {
      for (var i = 0; i < _lines.length; i++) {

        // Start and end of line could be in either order
        var a = [_lines[i].left_node, _lines[i].right_node].sort();
        var b = [option.left_node, option.right_node].sort();
