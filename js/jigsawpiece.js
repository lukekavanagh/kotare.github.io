 var ZERO = new THREE.Vector3();
        ...
        function generateShape() {
          ...
          var jigsaw = two.makePolygon(points);
        ...
        function addNub(a, b, list) {
          ...
          var midpoint = new Two.Vector()
            .copy(b).subSelf(a).divideScalar(4).addSelf(a);

          var angle = Two.Utils.angleBetween(a, b);
          ...
          var startAngle = Two.Utils.angleBetween(a, center);
          var endAngle = Two.Utils.angleBetween(b, center);
        ...
        function generateShadow() {
          ...
          }))), new THREE.MeshBasicMaterial({ color: 0x000000, transparent: true, side: THREE.DoubleSide }));
